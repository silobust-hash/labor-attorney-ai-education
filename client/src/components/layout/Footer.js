        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="col-span-1 md:col-span-2">
            <div className="flex items-center space-x-2 mb-4">
              ...
              <span className="text-xl font-bold">노무사 AI 교육</span>
            </div>
            <p className="text-secondary-300 mb-4 max-w-md">
              노무사 업무의 미래를 위한 AI 교육 플랫폼입니다. 
              인공지능 기술로 업무 효율성을 높이고 경쟁력을 강화하세요.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li>
                <Link to="/ai-tools" className="text-secondary-300 hover:text-white transition-colors duration-200">
                  AI 도구
                </Link>
              </li>
              <li>
